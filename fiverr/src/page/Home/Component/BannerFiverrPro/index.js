...
const BannerFiverrPro = () => {
  return (
    <div className="relative h-[750px] bg-green-950 mt-10 w-[1400px] m-auto overflow-hidden p-16 rounded-3xl">
      <div className="max-width-container h-[530px] mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="flex flex-col justify-center">
              ...
              <div className="kjKdXDB">
                ...
                >
                  <g fill="#fff">
                    ...
                    <path d="M116.757 11.2189H114.136C110.834 11.2189 109.755 14.2127 109.755 18.2277V26.5519H106.274V8.15259H109.757V11.6939C110.582 9.24771 112.018 8.15259 114.568 8.15259H116.758V11.2189H116.757Z" />
                    ...
                    <path d="M139 24.5201V24.5629C139 25.814 138.003 26.8294 136.771 26.8294C135.541 26.8294 134.542 25.8152 134.542 24.5629V24.5201C134.542 23.269 135.539 22.2537 136.771 22.2537C138.001 22.2537 139 23.269 139 24.5201Z" />
                  </g>
                </svg>
              </div>
            </i>
            ...
            <p className="text-banner-description mt-4">
            ...
            <p className="text-banner-highlight mt-4">
